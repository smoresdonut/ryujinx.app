...
<body>
	<div id="app">
		<div id="content" class="flex flex-auto flex-col pt-10 pb-4 h-[32rem] max-w-full bg-gray-900">
			<header class="flex items-center">
				<div class="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 container xl:max-w-7xl mx-auto px-4 lg:px-10">
					<a class="logo inline-flex items-center space-x-2 font-bold text-xl tracking-wide text-white" href="/">
						<img class="inline-block w-7 h-7" src="/favicon.png" alt="logo">
					...
					<div class="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 md:space-x-10">
						<nav class="space-x-4 md:space-x-6">
							<a class="font-semibold text-gray-300 hover:text-white" href="https://blog.ryujinx.app">
							<span>Blog</span>
							</a>
							...
							<a class="font-semibold text-gray-300 hover:text-white" href="https://github.com/Ryujinxemu/Ryujinx/wiki/Ryujinx-Setup-&-Configuration-Guide">
							<span>Guide</span>
							</a>
							<a class="font-semibold text-gray-300 hover:text-white" href="https://github.com/Ryujinxemu/Ryujinx/wiki/FAQ-and-Troubleshooting">
							<span>FAQ</span>
							</a>
							<a class="font-semibold text-gray-300 hover:text-white" href="/compatibility">
						...
						<div class="flex items-center justify-center space-x-3">
							...
							<a class="text-gray-400 hover:text-white" href="https://github.com/Ryujinxemu/Ryujinx" target="_blank">
							...
							<a class="text-gray-400 hover:text-white" href="https://discord.gg/eCajH8uyGm" target="_blank">
							...
							<a class="text-gray-400 hover:text-white" href="https://patreon.com/Ryujinxemu" target="_blank">
							<svg class="inline-block w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
							<path d="M512 194.8c0 101.3-82.4 183.8-183.8 183.8-101.7 0-184.4-82.4-184.4-183.8 0-101.6 82.7-184.3 184.4-184.3C429.6 10.5 512 93.2 512 194.8zM0 501.5h90v-491H0v491z"></path></svg></a>
						</div>
					</div>
				</div>
			</header>
				<div class="text-center container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py:32">
					<h1 class="text-center md:text-7xl text-white font-extrabold mb-6">Ryujinx</h1>
					<h2 class="md:text-3xl font-semibold mb-2 text-white">
					...
					Ryujinx is an open-source Nintendo Switch emulator created by
					<span class="text-red-50">gdkchan</span>
					and written in C#. This emulator aims at providing execellent accuracy and performance, a user-friendly interface, and consistent builds.
					</h2>
			...
			<div class="overflow:hidden">
				<div class="container xl:max-w-7xl mx-auto h-[45rem] px-4 py-16 lg:px-8 lg:py-32">
					<div class="flex flex-col lg:flex-row lg:items-center space-y-12 lg:space-y-0 lg:space-x-20">
						...
						<div>
							<div class="text-sm uppercase font-bold tracking-wider mb-1 text-blue-400">Ryujinx</div>
							<h2 class="text-3xl md:text-4xl font-extrabold mb-4 text-white">About the Project</h2>
							<h3 class="text-lg md:text-xl md:leading-relaxed font-medium text-gray-400">Written from scratch, the project began with a single developer in 2017 and continues on with a competent core team and help from dozens of contributors</h3>
						</div>
						</div>
						<div class="lg:w-7/12 xl:w-7/12 flex-none relative">
							<div class="pattern-dots-xl text-white absolute top-0 left-0 w-48 h-64 md:mt-20 transform -translate-x-10 -translate-y-10"></div>
						<div class="relative flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
							...
							<div class="group bg-[#131820] p-5 transition ease-out duration-200 border-2 border-gray-800 rounded-2xl hover:border-gray-700">
								<div class="inline-flex items-center justify-center w-10 h-10 m-2 mb-6 relative">
									...
									<svg class="text-white relative transform transition ease-out duration-200 group-hover:scale-110 hi-solid hi-adjustments inline-block w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
									<path fill-rule="evenodd" clip-rule="evenodd" d="M4.083 9h1.946c.089-1.546.383-2.97.837-4.118A6.004 6.004 0 004.083 9zM10 2a8 8 0 100 16 8 8 0 000-16zm0 2c-.076 0-.232.032-.465.262-.238.234-.497.623-.737 1.182-.389.907-.673 2.142-.766 3.556h3.936c-.093-1.414-.377-2.649-.766-3.556-.24-.56-.5-.948-.737-1.182C10.232 
									4.032 10.076 4 10 4zm3.971 5c-.089-1.546-.383-2.97-.837-4.118A6.004 6.004 0 0115.917 9h-1.946zm-2.003 2H8.032c.093 1.414.377 2.649.766 3.556.24.56.5.948.737 1.182.233.23.389.262.465.262.076 0 .232-.032.465-.262.238-.234.498-.623.737-1.182.389-.907.673-2.142.766-3.556zm1.166 4.118c.454-1.147.748-2.572.837-4.118h1.946a6.004 
								...
								<p class="class=leading-relaxed text-gray-400">The source code is available on <a class="text-blue-500" href="https://github.com/ryujinxemu/Ryujinx">Github</a> under the <a class="text-blue-500" href="https://github.com/ryujinxemu/Ryujinx/blob/master/LICENSE.txt">MIT license</a>.</p></div>
								<div class="group bg-[#131820] p-5 transition ease-out duration-200 border-2 border-gray-800 rounded-2xl hover:border-gray-700">
									<div class="inline-flex items-center justify-center w-10 h-10 m-2 mb-6 relative">
							...
							<div class="group bg-[#131820] p-5 transition ease-out duration-200 border-2 border-gray-800 rounded-2xl hover:border-gray-700">
								...
								<p class="leading-relaxed text-gray-400">Ryujinx has been tested on approximately 4,300 titles, over 4,100 boot past menus and into gameplay, with roughly 3,550 of those being considered playable.</p></div>
							    <div class="group bg-[#131820] p-5 transition ease-out duration-200 border-2 border-gray-800 rounded-2xl hover:border-gray-700">
								<div class="inline-flex items-center justify-center w-10 h-10 m-2 mb-6 relative">
			                ...
			                <div class="name bg-gray-900">
								<div class="space-y-16 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-20">
									<div class="text-center">
										<h2 class="text-3xl md:text-4xl font-extrabold mb-4 text-white">Why the <span class="text-sky-500">name</span>?</h2>
										<h3 class="text-lg md:text-xl md:leading-relaxed font-medium text-gray-400 lg:w-2/3 mx-auto">Pronounced <span class="italic">Ree-You-Jinx</span>. Based on the name "Ryujin" a mythical sea-god/dragon. The NX part of the name is from the Codename of the Switch itself.</h3>
									</div>
								</div>
							</div>
							<div class="space-y-16 container xl:max-w-7xl  mx-auto px-4 py-16 lg:px-8">
								<div class="text-center">
									<h2 class="text-3xl text-white md:text-4xl font-extrabold mb-4">Our team</h2>
									<h3 class="text-lg md:text-xl md:leading-relaxed font-medium text-gray-400 lg:w-2/3 mx-auto">These developers are working nonstop to continue development of Ryujinx.</h3>
								</div>
								<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-16 text-center">
									<div></div>
									<div><span class="inline-block rounded-full bg-white shadow-lg p-2 mb-5"><img class="inline-block w-28 h-28 rounded-full select-none" src="https://avatars.githubusercontent.com/u/69540471?v=4" draggable="false" alt="Donut"></span>
									<h4 class="text-xl font-semibold mb-1"><a class="text-blue-400" href="https://github.com/smoresdonut">donut</a></h4>
									<p class="text-gray-400 font-medium">Lead Developer / Web Designer</p>
									</div>
								</div>
							</div>
							<div class="bg-[#151e31] overflow-hidden">
								<div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
									<div class="text-center mb-16">
										<div class="text-sm uppercase font-bold tracking-wider mb-1 text-blue-400">Support Us</div>
										<h2 class="text-3xl text-white md:text-4xl font-extrabold mb-4">Get In Touch</h2>
										<h3 class="text-lg md:text-xl md:leading-relaxed font-medium text-gray-400 lg:w-2/3 mx-auto">If you have something you'd like to contribute to the project, need emulator support or just want to get in touch with the team, contact us on <a class="text-blue-500" href="https://bsky.app/profile/ryujinx.app">Bluesky</a> or <a class="text-blue-500" href="https://discord.gg/eCajH8uyGm">Discord</a>.</h3>
									</div>
									<div class="relative">
										<div class="pattern-dots-md text-white absolute top-0 right-0 w-32 h-32 transform -translate-y-12 translate-x-12"></div>
										<div class="pattern-dots-md text-white absolute bottom-0 left-0 w-32 h-32 transform translate-y-12 -translate-x-12"></div>
										<div class="grid grid-cols-1 sm:grid-cols-3 text-center rounded-xl shadow-md bg-[#131820] divide-y sm:divide-y-0 sm:divide-x divide-gray-800 overflow-hidden relative">
											<div class="space-y-1 px-5 py-12"> <div class="text-4xl font-extrabold text-blue-400">0</div> <div class="text-sm text-white uppercase tracking-wide font-bold">Github Stars</div></div>
										...
										<div class="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-16">
										</div>
									</div>
								</div>
							</div>
							<footer class="bg-[#15171A] border-t-2 border-gray-800">
								<div class="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 h-20 py-16 lg:px-8 lg:py-16">
									<div class="flex items-center justify-center space-x-3">
										<a class="text-gray-400 hover:text-white" href="https://bsky.app/profile/ryujinx.app" target="_blank">
											<svg class="inline-block w-5 h-5" fill="currentColor" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
											<path d="M407.8 294.7c-3.3-.4-6.7-.8-10-1.3c3.4 .4 6.7 .9 10 1.3zM288 227.1C261.9 176.4 190.9 81.9 124.9 35.3C61.6-9.4 37.5-1.7 21.6 5.5C3.3 13.8 0 41.9 0 58.4S9.1 194 15 213.9c19.5 65.7 89.1 87.9 153.2 80.7c3.3-.5 6.6-.9 10-1.4c-3.3
									...
									<div class="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 container xl:max-w-7xl mx-auto px-4 lg:px-10 s-y_bCXRrkrYfP">
										<div class="text-gray-300"><span class="font-bold">Ryujinx © 2024</span></div>
									</div>
								</div>
							</footer>
						</div>
