<footer class="bg-[#000913] border-t-2 border-gray-900">
    <div class="flex flex-col md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 h-20 py-16 lg:px-8 lg:py-16">
        <div class="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 container xl:max-w-7xl mx-auto px-4 lg:px-10">
            ...
            <nav class="space-x-3">
                ...
                <a class="font-semibold text-gray-300 hover:text-white" href="https://discord.gg/ryujinx"><span class="">Contribute</span></a>
            </nav>
            ...
            <a class="text-gray-300 hover:text-white" href="https://discord.gg/ryujinx" target="_blank">
                ...
                1.612-1.438 1.612Zm5.316 0c-.788 0-1.438-.724-1.438-1.612 0-.889.637-1.613 1.438-1.613.807 0 1.451.73 1.438 1.613 0 .888-.631 1.612-1.438 1.612Z"></path></svg></a></nav>
        </div>
</footer>